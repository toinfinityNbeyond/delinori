...
public class WebConfig extends AbstractAnnotationConfigDispatcherServletInitializer {
    ...
    protected Class<?>[] getRootConfigClasses() {//루트설정
        ...
        return new Class[]{RootConfig.class, SecurityConfig.class}; //, NoticeRootConfig.class
    }
    ...
    protected Class<?>[] getServletConfigClasses() {//서블릿설정
        ...
        return new Class[]{ServletConfig.class , SecurityServletConfig.class}; //, NoticeServletConfig.class
    }
